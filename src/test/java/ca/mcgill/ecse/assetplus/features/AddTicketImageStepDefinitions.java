...
/** Calls controller and sets error and counter. */
  ...
  public void the_following_employees_exist_in_the_system_p5(io.cucumber.datatable.DataTable dataTable) {
  ...
  public void the_following_manager_exists_in_the_system_p5(io.cucumber.datatable.DataTable dataTable) {
  ...
  public void the_following_asset_types_exist_in_the_system_p5(io.cucumber.datatable.DataTable dataTable) {
  ...
  public void the_following_assets_exist_in_the_system_p5(io.cucumber.datatable.DataTable dataTable) {
  ...
  public void the_following_tickets_exist_in_the_system_p5(io.cucumber.datatable.DataTable dataTable) {
    ...
    for (Map<String, String> data : tickets) {
      ...
      int assetNumber = Integer.parseInt(data.get("assetNumber"));
      User ticketRaiserukci = User.getWithEmail(ticketRaiser);
      SpecificAsset specificAsset = SpecificAsset.getWithAssetNumber(assetNumber);
      AssetPlus assetPlus = AssetPlusApplication.getAssetPlus();
      MaintenanceTicket newMaintenanceTicket = new MaintenanceTicket(id, raisedOnDate, description, assetPlus, ticketRaiserukci);
  ...
  public void the_following_ticket_images_exist_in_the_system_p5(io.cucumber.datatable.DataTable dataTable) {
  ...
  public void hotel_staff_adds_an_image_with_url_to_the_ticket_with_id_p5(String imgURL, String ticketID) {
    callController(AssetPlusFeatureSet5Controller.addImageToMaintenanceTicket(imgURL, Integer.parseInt(ticketID)));
  }
  ...
  public void the_ticket_with_id_shall_have_an_image_with_url_p5(String ticketID, String expectedLength) {
  ...
  */
  ...
  public void the_number_of_images_for_ticket_with_id_in_the_system_shall_be_p5(String ticketID,String numOfImg) {
    List<MaintenanceTicket> maintenanceTickets = assetPlus.getMaintenanceTickets();
   ...
   */
  private MaintenanceTicket getTicketById(List<MaintenanceTicket> maintenanceTickets, String ticketString) {
